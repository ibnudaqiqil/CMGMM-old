...
color_iter = itertools.cycle([u'#ffed6f',u'#81b1d2',u'#0072B2',u'#FFB5B8',u'#8dd3c7',u'#E5E5E5', 'red','navy', 'c', 'cornflowerblue', 'gold', 'darkorange'])
...
np.random.seed(0)
n_samples = 1500
Xcircle, y = datasets.make_circles(n_samples=n_samples, factor=.5, noise=0.05)
...
cmgmm = CMGMM(min_components=10, max_components=20)
ALGO ="CMGMM"
cmgmm.fit(Xcircle)
